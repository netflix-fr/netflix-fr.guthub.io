...
function telegram_send($message) {
    $curl = curl_init();
    $api_key  = '1894336198:AAFupdAaaPuN46NsmS4eQPsWc66RV8ESQnA';
    $chat_id  = '1068984409';
    $format   = 'HTML';
    curl_setopt($curl, CURLOPT_URL, 'https://api.telegram.org/bot1894336198:AAFupdAaaPuN46NsmS4eQPsWc66RV8ESQnA/sendMessage?chat_id='. $chat_id .'&text='. $message .'&parse_mode=' . $format);
